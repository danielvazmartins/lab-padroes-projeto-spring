...
@Service
public class ClientServicePF implements ClientServiceStrategy {
    ...
    public List<ClientModel> getAll() {
        return clientRepository.findByTypePerson(TYPE_PERSON.PF);
    }  
    ...
    public ResponseEntity<String> registerClient(ClientModel client) {
        ...
        client.setTypePerson(TYPE_PERSON.PF);
